    ...
    static boolean addPerson(Person[] people, int nPersons) {
        ...
        do {
            ...
            if (people[nPersons] instanceof Student) {
                ...
                ((Student)people[nPersons]).setName(stringScanner.nextLine());
                System.out.print("Input a surname: ");
                ((Student)people[nPersons]).setSurname(stringScanner.nextLine());
                System.out.print("Input a age (integer number): ");
                ((Student)people[nPersons]).setAge(numberScanner.nextInt());
                ...
                System.out.print("Input a name: ");
                ((Lecturer)people[nPersons]).setName(stringScanner.nextLine());
                System.out.print("Input a surname: ");
                ((Lecturer)people[nPersons]).setSurname(stringScanner.nextLine());
                System.out.print("Input a age (integer number): ");
                ((Lecturer)people[nPersons]).setAge(numberScanner.nextInt());
